...
{
    public class ParentChangeNameDialog : Dialog
    {
        Button cancel;
        Button submit;
        EditText newName;
        TextView errortext;
        public ParentChangeNameDialog(Activity activity, ParentAccount account) : base(activity)
        {
            m_activity = activity;
            m_account = account;
        }
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            ParentDatabaseQueries db = new ParentDatabaseQueries(m_account);
